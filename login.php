...
<body class="d-flex flex-column min-vh-100">
    ...
    <main class="flex-fill min-h-100 d-flex flex-column justify-content-center align-items-center">
        ...
        <div id="loginform" class="container-fluid d-flex flex-column justify-content-center align-items-center m-3">
            <div class="card shadow col-xl-5 col-lg-7 col-md-8">
                <div class="card-body">
                    <h1 class="card-title text-center mb-4">Logear</h1>
        ...
        <script>
                    ...
                    if (this.checkValidity()) {
                        ...
                        fetch('api_post_login.php', {
                            ...
                            .catch(error => {
                                ...
                                formMessage.textContent = 'Ocurrió un error al enviar el formulario.' + error;
                            });
                    }
            ...
            function manejarRespuesta(data) {
                ...
                if (data.status == "exito") {
                    ////EXIT //////////////////////////////////////////////////////////////////////////////
                    const mensaje = encodeURIComponent("Iniciaste seccion con exito...");
